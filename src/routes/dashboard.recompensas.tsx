...
export const Route = createFileRoute("/dashboard/recompensas")({
  head: () => ({
    meta: [
      { title: "Recompensas — Botanique Luxe" },
      {
        name: "description",
        content: "Catálogo de recompensas exclusivas del Club Botanique Luxe.",
      },
    ],
  }),
...
const rewards = [
  {
    ...
    description: 'Aplica en la colección "Primavera Eterna".',
    points: 400,
    category: "Descuentos",
    expires: "31 Dic 2024",
  },
  {
    ...
    title: "Envío nacional cortesía",
    description: "Envío programado a cualquier ciudad del país.",
    points: 600,
    category: "Envíos",
  ...
  },
  {
    ...
    description: "Una tarjeta lacrada para regalar en cualquier ocasión.",
    points: 800,
    category: "Regalos",
    expires: "31 Dic 2024",
  },
  {
    ...
    title: "Ramo sorpresa del atelier",
    description: "Composición única diseñada por nuestros floristas.",
    points: 1000,
    category: "Regalos",
    expires: "31 Mar 2025",
  },
  {
    ...
    description: "Una sesión 1:1 con nuestra florista principal.",
    points: 1500,
  ...
  {
    image: rewardDiscount,
    title: "30% en decoración de evento",
    description: "Para tu próximo evento corporativo o íntimo.",
    points: 2200,
    category: "Descuentos",
    expires: "31 Dic 2024",
  },
