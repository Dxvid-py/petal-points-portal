...
export function Logo({ to = "/", variant = "default" }: LogoProps) {
  return (
    <Link to={to} className="group flex items-center gap-3" aria-label="Puntos Deluxe — Inicio">
      <span
        className={[
          "relative flex h-11 w-11 items-center justify-center overflow-hidden rounded-full border-2 bg-white shadow-soft transition-transform group-hover:rotate-6",
